...
5. Return as a JSON array of objects with title and type properties`,
  ...
  IMAGE_PROMPT: (blockTitle: string) => `
Create a cartoon-style, kid-friendly image description based on the content block titled: "${blockTitle}."
The image should:
1. Be colorful, whimsical, and fun
2. Match the theme of the block
3. Include small, playful details to delight kids`,

...
export const TopicBlock: React.FC<TopicBlockProps> = ({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className={cn(
        "flex flex-col items-start p-6 rounded-xl w-full sm:w-[280px] h-[160px] transition-all",
        "hover:shadow-xl relative overflow-hidden text-app-text-light",
        color,
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-left opacity-90 line-clamp-2">
          {description && !description.includes("Click to explore more") 
            ? description 
